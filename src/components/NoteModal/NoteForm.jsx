    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        <input
          ...
          placeholder="Header"
          className={`w-full h-[56px] px-4 bg-[#f4f4f4] rounded-[10px] ${placeholderStyles} ${
      ...
      {formData.type === NOTE_TYPES.IMAGE && (
        <div>
          <div
            className={`border-2 border-dashed rounded-[10px] p-8 ${
      ...
      <div>
        <textarea
          ...
          className={`w-full h-[128px] px-4 py-3 bg-[#f4f4f4] rounded-[10px] resize-none ${placeholderStyles} ${
